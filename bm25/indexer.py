...
def index_webTables(args):
    ...
    elastic = Elastic(args.index_name,timeout = 200)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--index_name', help='Name of the elasticsearch index to be constructed', required=True)
    parser.add_argument('--input_json', help='Path to the json file containing all the tables \
        information used to construct the index', required=True)

    args = parser.parse_args()

    index_webTables(args)
