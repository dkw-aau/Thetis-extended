...
class Elastic(object):
    ...
    def search(self, query, field, num=1000, fields_return="", start=0):
    ...
    def get_field_stats(self, field):
        ...
        return self.__es.indices.stats(index=self.__index_name, fields=[field])["indices"]["_all"]["fields"][field]
